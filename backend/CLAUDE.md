...
| `alembic/versions/` | Migration chain `0001`→`0027` (`0022` logo, `0023` deals, `0024` escrow, `0025` offer sale fields, `0026` rfq push log, `0027` compliance); earlier: `0001`→`0021` (`0017` R1 verification/portal, `0018` R2 dual-origin requests/inquiries + `portal_notifications`, `0019` market-list index, `0020` R3 E-IMZO rails — `signature_evidence`/`company_person_data`/`integration_call_log`, `0021` R3 contracts). |
