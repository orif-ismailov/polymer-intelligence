...
class TestSourceGroupsApi:
    def test_list_groups(self) -> None:
        ...
        with patch("app.domains.signals.api_admin.source_service.list_source_groups", return_value=groups):
    ...
    def test_sources_brief(self) -> None:
        ...
        with patch("app.domains.signals.api_admin.source_service.list_sources_brief", return_value=brief):
    ...
    def test_set_group(self) -> None:
        ...
        with patch("app.domains.signals.api_admin.source_service.set_source_group", return_value=True), \
             patch("app.domains.signals.api_admin.source_service.list_sources_brief", return_value=[updated]):
    ...
    def test_set_group_404(self) -> None:
        with patch("app.domains.signals.api_admin.source_service.set_source_group", return_value=False):
