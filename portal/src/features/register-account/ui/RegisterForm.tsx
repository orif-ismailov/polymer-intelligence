 ...
 */
export function RegisterForm({ onSubmitted }: RegisterFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      ...
      <FormField label={t("register.companyName")} required hint={t("register.companyHint")}>
        {({ id, invalid, describedBy }) => (
          <Input
            id={id}
      ...
      <FormField label={t("register.note")} hint={t("register.noteHint")}>
        {({ id, describedBy }) => (
          <Textarea
            id={id}
            rows={3}
