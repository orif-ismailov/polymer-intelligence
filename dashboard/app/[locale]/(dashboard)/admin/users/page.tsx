  ...
  if (users.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 gap-3 text-center">
        ...
        <p className="text-sm text-foreground-muted">No staff users found.</p>
      </div>
    );
  }
      ...
      <table className="w-full text-sm">
        <thead className="bg-background-tertiary">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-semibold text-foreground-muted uppercase tracking-wider">Created At</th>
          </tr>
        </thead>
